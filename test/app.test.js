...
jest.mock('../src/components/Dashboard/Dashboard', () => () => <div>Dashboard</div>);
jest.mock('../src/components/login.jsx', () => ({
  Login: () => <div>Login</div>
}));
jest.mock('../src/components/AuthLoading.jsx', () => ({
  AuthLoading: () => <div>Loading...</div>
}));
jest.mock('../src/pages/Profile/Profile', () => () => <div>Profile</div>);
jest.mock('../src/pages/Classes/Classes', () => () => <div>Classes</div>);
